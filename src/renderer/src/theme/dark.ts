...
export function baseDarkThemeOverrides(primaryColor = ''): GlobalThemeOverrides {
  return {
    ...
    Button: {
      textColorPrimary: twColor('neutral', 950),
      textColorHoverPrimary: twColor('neutral', 950),
      textColorPressedPrimary: twColor('neutral', 950),
      textColorFocusPrimary: twColor('neutral', 950),
      textColorSupplPrimary: twColor('neutral', 950),
